...
def validate():
    ...
    # ***********************************************************************
    # add gapfilled reactions or random reactions selected from reaction pool
    # ***********************************************************************
    ...
    # output_file: str = "%s/%s" % (paras['OUTPUT_DIRECTORY'])
    df_output.to_csv(output_file, index=False)

    # df_output.to_csv(output_file,'./results/fba_result/' + gem_file.replace('.xml', '') +'.csv')
    print('done for valid!')
