...
def add_gapfilled_reactions(gem_file, universe, paras):
    ...
    for cobra_reaction in model_w_gapfill.reactions:
        cobra_reaction.lower_bound = float(cobra_reaction.lower_bound)
    cobra.io.write_sbml_model(model_w_gapfill, f'./results/universe/random_add5draft_gem_1/{gem_file}' + '.xml')
